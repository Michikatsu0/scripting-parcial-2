...
public class BoidWithoutF : MonoBehaviour
{
    ...
    private List<BoidWithoutF> cohesionNeighbours = new List<BoidWithoutF>();
    private List<BoidWithoutF> avoidanceNeighbours = new List<BoidWithoutF>();
    private List<BoidWithoutF> aligementNeighbours = new List<BoidWithoutF>();
